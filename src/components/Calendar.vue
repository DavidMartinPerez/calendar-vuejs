    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
          <v-btn color="primary" dark class="mr-4" @click="dialog = true">Añadir Evento</v-btn>
        ...
        >
          <v-card color="grey lighten-4" min-width="350px" flat>
            ...
            <v-card-text>
              ...
              <v-form v-else>
                <v-text-field type="text" v-model="selectedEvent.name"></v-text-field>
                <textarea-autosize
...
export default {
  ...
  methods: {
    async getEvents() {
      //Recuperamos los eventos desde firebase
      try {
